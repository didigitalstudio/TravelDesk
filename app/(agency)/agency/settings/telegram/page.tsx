...
export default async function AgencyTelegramPage() {
  ...
  const [{ data: link }, features] = await Promise.all([
    supabase
      .from("telegram_links")
  ...
  return (
    <div className="space-y-6">
      <FeatureGate
        enabled={features.telegram ?? false}
        message="Integrá Telegram para recibir solicitudes — disponible en Starter y Pro"
      >
